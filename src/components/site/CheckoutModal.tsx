...
const methods = [
  {
    name: "PayPal",
    emoji: "💳",
    url: "https://paypal.me/theduke321",
  },
  {
    name: "Cash App",
    emoji: "💵",
    url: "https://cash.app/$thedukeLazR",
  },
  {
    name: "Venmo",
    emoji: "💸",
    url: "https://www.venmo.com/u/LazRtheduke",
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="mt-2 text-3xl font-display font-bold text-gradient-neon">
          {service.price}
        </div>
        ...
        {!paid ? (
          <>
            ...
            <p className="mt-6 text-xs text-muted-foreground text-center">
              Secure third-party payment. You'll be redirected to complete the
              transaction.
            </p>

            <button
              onClick={() => setPaid(true)}
              className="mt-4 w-full btn-neon rounded-2xl py-3 font-semibold"
            >
              I Have Paid
            </button>
          </>
          ...
          <div className="mt-6 text-center">
            <div className="mx-auto h-16 w-16 rounded-full bg-gradient-neon-soft border border-primary/40 flex items-center justify-center shadow-glow-purple">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Open a ticket in our Discord with proof of purchase to start your
              project.
            </p>
